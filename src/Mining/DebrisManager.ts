...
const ORE_TO_BLOCK_ID: Map<string, number> = new Map([
  ...
  // Island 5 ores
  [ISLAND5_ORE_TYPE.VOID_DUST, 143],
  [ISLAND5_ORE_TYPE.BLACKSTONE_SHARD, 133],
  [ISLAND5_ORE_TYPE.NULL_PEBBLE, 138],
  [ISLAND5_ORE_TYPE.ECLIPSE_SAND, 127],
  [ISLAND5_ORE_TYPE.UMBRAL_CLAY, 141],
  [ISLAND5_ORE_TYPE.GLOOM_QUARTZ, 135],
  [ISLAND5_ORE_TYPE.RIFTSTONE, 139],
  [ISLAND5_ORE_TYPE.ABYSSAL_BASALT, 128],
  [ISLAND5_ORE_TYPE.SHADOWGLASS, 140],
  [ISLAND5_ORE_TYPE.MIDNIGHT_OBSIDIAN, 137],
  [ISLAND5_ORE_TYPE.VEIL_CRYSTAL, 142],
  [ISLAND5_ORE_TYPE.WRAITH_ORE, 129],
  [ISLAND5_ORE_TYPE.SINGULARITY_FRAGMENT, 130],
  [ISLAND5_ORE_TYPE.EVENTIDE_PRISM, 134],
  [ISLAND5_ORE_TYPE.GRAVITY_CORE, 136],
  [ISLAND5_ORE_TYPE.ANTIMATTER_NODULE, 131],
  [ISLAND5_ORE_TYPE.DARKSTAR_ALLOY, 144],
  [ISLAND5_ORE_TYPE.VOIDHEART_GEM, 146],
  [ISLAND5_ORE_TYPE.REALITY_TEAR, 145],
  [ISLAND5_ORE_TYPE.OBLIVIONITE, 132],
]);
...
export class DebrisManager {
  ...
  spawnDebris(
    ...
    const oreData =
      ...
      (oreType in ISLAND5_ORE_DATABASE && ISLAND5_ORE_DATABASE[oreType as ISLAND5_ORE_TYPE]);
    if (!oreData) {
