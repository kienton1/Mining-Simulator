 ...
 * Gem Trader Entity
 * 
 * Creates an immovable NPC that players can interact with to purchase gem upgrades.
 * When a player gets within 3 blocks, they can interact to open the upgrades UI.
 * 
 * Position: x: 14.83, y: 1.75, z: 9.29
...
export class GemTraderEntity {
  ...
  /**
   * Creates a new GemTraderEntity instance
   * 
